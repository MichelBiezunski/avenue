...
@register.inclusion_tag('infoloom_website/tags/top_menu.html', takes_context=True)
...
@register.inclusion_tag(
    'infoloom_website/tags/top_menu_children.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'infoloom_website/tags/standard_index_listing.html',
    takes_context=True
)
...
@register.inclusion_tag('infoloom_website/tags/breadcrumbs.html', takes_context=True)
...
# Footer snippets
@register.inclusion_tag('infoloom_website/tags/footer.html', takes_context=True)
def footer(context):
    return {
...
# Feed Video
@register.inclusion_tag('infoloom_website/tags/feed.html', takes_context=True)
def feed(context):
    return {
